...
import importlib
import logging
from klabban.web.utils import template_filters
...
def register_blueprint(app):
    ...
    app.add_template_filter(template_filters.format_month_th)
    app.add_template_filter(template_filters.format_thai_date)
    app.add_template_filter(template_filters.format_thai_date_short_month)
